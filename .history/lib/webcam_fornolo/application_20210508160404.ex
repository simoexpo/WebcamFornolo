defmodule WebcamFornolo.Application do
  ...
  def start(_type, _args) do
    ...
    session = RTSP.Session.start_link("rtsp://#{username}:#{password}@81.174.23.123:8001")
  ...
  def asd(session) do
    ...
    {:ok, desc1} = RTSP.describe(session)
    ...
    {:ok, %Response{status: 200}} = RTSP.get_parameter(session, "/videoMain", [])
