defmodule WebcamFornolo.Service.Media.MediaFileServiceTest do
  ...
  test "MediaFileService should save a media file" do
    media = a_media_file()
  ...
  test "MediaFileService should return a list of media file paginated" do
    {:ok, %{total_pages: n, items: result}} = MediaFileService.get_media_paginated(1, 10, DummyMediaFileDao.SuccessImpl)
