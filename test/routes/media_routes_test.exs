defmodule WebcamFornolo.MediaRoutesTest do
  ...
  test "GET /media should return 200 OK with media list" do
    conn = :get
    |> conn("/media")
  ...
  test "GET /media should return 500 Internal Server Error in case of unexpected error" do
    conn = :get
    |> conn("/media")
  ...
  test "POST /media should return 201 Created" do
    conn = :post
    |> conn("/media", %{image: webcam_image_to_upload()})
    |> assign(:provider, FakeMediaService.SuccessImpl)
    |> Routes.call(@opts)
  ...
  test "POST /media should return 500 Internal Server Error" do
    conn = :post
    |> conn("/media", %{image: webcam_image_to_upload()})
    |> assign(:provider, FakeMediaService.ErrorImpl)
    |> Routes.call(@opts)
  ...
  test "DELETE /media/id should return 204 No Content id the id is valid" do
    conn = :delete
    |> conn("/media/id")
    |> assign(:provider, FakeMediaService.SuccessImpl)
    |> Routes.call(@opts)
  ...
  test "DELETE /media/id should return 404 Not Found id the id is not valid" do
    conn = :delete
    |> conn("/media/id")
  ...
  test "DELETE /media/id should return 500 Internal Server Error in case of unexpected error" do
    conn = :delete
    |> conn("/media/id")
    |> assign(:provider, FakeMediaService.ErrorImpl)
    |> Routes.call(@opts)
